...
export default function WalletPage() {
  ...
  const fee = amt > 0 ? amt * BONUS_RATES.management_fee_deposit : 0;
  const net = amt - fee;
  ...
  return (
    <div className="max-w-4xl space-y-8">
      <div>
        ...
        <p className="text-gray-400 text-sm mt-1">Deposit BNB on BNB Smart Chain</p>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div className="glass rounded-2xl p-6 text-center" style={{ border: '1px solid rgba(202,138,4,0.3)', background: 'rgba(202,138,4,0.05)' }}>
          ...
          <p className="text-gray-500 text-xs mt-1">BNB · 10% fee on deposits</p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
        ...
        <div className="glass rounded-2xl p-6 gold-border-glow">
          <h3 className="text-white font-bold mb-6 flex items-center gap-2">
            <ArrowDownLeft className="w-4 h-4 text-amber-400" /> Deposit BNB
          </h3>
            ...
            {amt > 0 && (
              <div className="p-4 rounded-xl space-y-2"
                ...
                <div className="border-t border-white/10 pt-2 flex justify-between text-sm font-bold">
                  <span className="text-gray-300">Net Credited</span>
