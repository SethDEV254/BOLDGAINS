...
export default function TeamViewMembersPage() {
  ...
  // No backend action exists for this panel — every mutation below is display only.
  ...
  function patchUser(successMsg: string) {
    setWorking(true);
    setTimeout(() => {
                        ...
                        <div className="flex items-center gap-1.5">
                          {isPending ? (
                            <button title="Approve — activate this account"
                              onClick={() => patchUser(`${u.name} approved`)}
                            ...
                            <button title={isSuspended ? 'Activate' : 'Suspend'}
                              onClick={() => patchUser(isSuspended ? `${u.name} activated` : `${u.name} suspended`)}
              ...
              <>
                ...
                <div className="space-y-4">
                  ...
                  <button disabled={!balanceAmt || working}
                    onClick={() => patchUser('Balance updated')}
              ...
              <>
                ...
                <div className="space-y-4">
                  ...
                  <button disabled={working}
                    onClick={() => patchUser('Package updated')}
                    className="btn-gold w-full py-3 rounded-xl font-bold text-sm flex items-center justify-center gap-2">
