...
export default function TeamViewLayout({ children }: { children: React.ReactNode }) {
  ...
  async function handleLogout() {
    ...
    router.push('/team-view/login');
  }

  if (pathname === '/team-view/login') return children;

  const SidebarContent = () => (
    <div className="flex flex-col h-full">
      <div className="p-6 border-b border-amber-900/20">
        <Link href="/team-view" className="flex items-center gap-3" onClick={() => setSidebarOpen(false)}>
